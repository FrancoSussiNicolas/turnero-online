...
('Consultorio 2A', @ESTADO_INICIAL), ('Consultorio 2B', @ESTADO_INICIAL),
('Consultorio 3A', @ESTADO_INICIAL), ('Consultorio 3B', @ESTADO_INICIAL),
...
('Gastroenterología', @ESTADO_INICIAL), ('Pediatría', @ESTADO_INICIAL),
('Oftalmología', @ESTADO_INICIAL), ('Neurología', @ESTADO_INICIAL),
...
('Galeno', @ESTADO_INICIAL), ('Medicus', @ESTADO_INICIAL),
('Hospital Italiano', @ESTADO_INICIAL), ('Omint', @ESTADO_INICIAL),
...
('Plan Plata', 'Cobertura Media', @ESTADO_INICIAL, 1),
('Plan Oro', 'Cobertura Premium', @ESTADO_INICIAL, 1),
('Plan Inicial', 'Cobertura básica', @ESTADO_INICIAL, 2),
('Plan Intermedio', 'Cobertura media', @ESTADO_INICIAL, 2),
('Plan Superior', 'Cobertura total', @ESTADO_INICIAL, 3),
('Plan Familiar', 'Cobertura familiar', @ESTADO_INICIAL, 4),
('Plan Senior', 'Para adultos mayores', @ESTADO_INICIAL, 5),
...
('2025-10-29', '10:30:00', @ESTADO_INICIAL, 2, 2, 2),
('2025-10-31', '11:00:00', @ESTADO_INICIAL, 3, 3, 3),
('2025-11-03', '09:30:00', @ESTADO_INICIAL, 4, 4, 4),
('2025-11-05', '11:30:00', @ESTADO_INICIAL, 5, 5, 5),
('2025-11-07', '14:00:00', @ESTADO_INICIAL, 6, 6, 6),
('2025-11-10', '15:00:00', @ESTADO_INICIAL, 7, 7, 7),
('2025-11-12', '16:00:00', @ESTADO_INICIAL, 8, 8, 8),
